...
import { ApiPage, ApiCategory, ApiProduct } from '../../models/catalog-api.model';
...
export class CatalogApiService {
  ...
  getCategories(opts: {
    ...
    return this.http.get<ApiPage<ApiCategory>>(
      `${this.baseUrl}/api/categories/page`,
      { params }
    );
  }
  ...
  getProductsByCategoryId(opts: {
    ...
    return this.http.get<ApiProduct[]>(
      `${this.baseUrl}/api/categories/${opts.categoryId}/products`,
      { params }
    );
  }
  ...
  getBundlesByStoreId(opts: { storeId: string; inventoryStock?: boolean }) {
    ...
    return this.http.get<ApiProduct[]>(
      `${this.baseUrl}/api/products/stores/${opts.storeId}/bundles`,
      { params }
    );
  }
}
